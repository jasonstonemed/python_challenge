...
# months = sum(1 for row in reader) # counter

# print(f'The number of months in the file is: {months}')
...
# # print(f'The net total amount of "Profit/Losses" over {months} months is: ${total_profit_loss}')
...
# print(f'The changes in "Profit/Losses" over {months} months is: ${total_change}')
